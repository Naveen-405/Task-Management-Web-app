...
const icons = {
  ...
  error: (
    <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
      <circle cx="12" cy="12" r="10" />
      <path fill="white" d="M15.536 8.464a1 1 0 010 1.414L13.414 12l2.122 2.122a1 1 0 01-1.414 1.414L12 13.414l-2.122 2.122a1 1 0 01-1.414-1.414L10.586 12 8.464 9.878a1 1 0 011.414-1.414L12 10.586l2.122-2.122a1 1 0 011.414 0z" />
    </svg>
  ),
};
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0 pt-0.5">
        ...
        {message && (
          <p className={`m-0 text-sm text-gray-500 leading-relaxed ${title ? "mt-0.5" : ""}`}>
            {message}
          </p>
        )}
      </div>
